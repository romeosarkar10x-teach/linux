...
**16 chapters (0–15) · 103 lessons.**

> Per-chapter exercise counts were removed from this file on 2026-08-23. They were estimates, they
> were wrong (Chapter 0 was estimated at ~12 and shipped 50), and leaving them here invited trimming
> a chapter to hit a number. ~50 per chapter is a floor — `CONTEXT.md` §4.5.
...
### Chapter 0 — Boarding the Kestrel (setup) · 6 lessons
...
### Chapter 1 — Shell & Terminal, Properly · 7 lessons
...
### Chapter 2 — Navigating the Filesystem · 7 lessons
...
### Chapter 3 — Files, Links & Types · 6 lessons
...
### Chapter 4 — Creating, Copying & Destroying · 5 lessons
...
### Chapter 5 — Globbing & Quoting · 5 lessons *(all new)*
...
### Chapter 6 — Searching: grep, regex & find · 7 lessons
...
### Chapter 7 — Text Processing Pipelines · 8 lessons *(all new)*
...
### Chapter 8 — Streams, Redirection & Exit Codes · 6 lessons
...
### Chapter 9 — Processes & Job Control · 7 lessons
...
### Chapter 10 — Users, Groups & Permissions · 8 lessons
...
### Chapter 11 — Environment & Shell Configuration · 6 lessons
...
### Chapter 12 — Shell Scripting · 9 lessons
...
### Chapter 13 — Packages, Docs & Editors · 6 lessons
...
### Chapter 14 — Archives, Disks & Integrity · 5 lessons *(all new)*
...
5. `05-incident-13` — CTF: an archive that passes its own checksums and fails a hand-written
   manifest. The arc's proof; see `_handoff/SCENARIOS.md` §7.

### Chapter 15 — Final Capstone: The Kestrel Breach · 5 lessons
