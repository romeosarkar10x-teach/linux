# SYLLABUS — Kestrel Linux

**16 chapters · 103 lessons.**

Exercise counts aren't listed. There are a lot of them — around fifty a chapter, sometimes more —
and the number is not the point.

Chapters are strictly ordered: nothing appears in an exercise before the lesson that teaches it.
Do them in order.

`(review)` means boot.dev covered it and we're drilling it properly. `(review+)` means boot.dev
covered it and this course goes further. Unmarked topics are new to you.

---

### [Chapter 0 — Boarding the Kestrel (setup)](00-boarding-the-kestrel/README.md) · 6 lessons
...
### [Chapter 1 — Shell & Terminal, Properly](01-shell-and-terminal/README.md) · 7 lessons
...
### [Chapter 2 — Navigating the Filesystem](02-navigating-the-filesystem/README.md) · 7 lessons
...
### [Chapter 3 — Files, Links & Types](03-files-links-and-types/README.md) · 6 lessons
...
### [Chapter 4 — Creating, Copying & Destroying](04-creating-copying-destroying/README.md) · 5 lessons
...
### [Chapter 5 — Globbing & Quoting](05-globbing-and-quoting/README.md) · 5 lessons *(all new)*
...
### [Chapter 6 — Searching: grep, regex & find](06-searching/README.md) · 7 lessons
...
### [Chapter 7 — Text Processing Pipelines](07-text-processing/README.md) · 8 lessons *(all new)*
...
### [Chapter 8 — Streams, Redirection & Exit Codes](08-streams-and-redirection/README.md) · 6 lessons
...
### [Chapter 9 — Processes & Job Control](09-processes-and-job-control/README.md) · 7 lessons
...
### [Chapter 10 — Users, Groups & Permissions](10-users-groups-permissions/README.md) · 8 lessons
...
### [Chapter 11 — Environment & Shell Configuration](11-environment-and-config/README.md) · 6 lessons
...
### [Chapter 12 — Shell Scripting](12-shell-scripting/README.md) · 9 lessons
...
### [Chapter 13 — Packages, Docs & Editors](13-packages-docs-editors/README.md) · 6 lessons
...
### [Chapter 14 — Archives, Disks & Integrity](14-archives-disks-integrity/README.md) · 5 lessons *(all new)*
...
4. `04-checksums` — `sha256sum`, `md5sum`, `-c` verification, what a checksum does and doesn't prove
5. `05-incident-13` — an archive that passes its own checksums and fails a manifest somebody wrote
   by hand. Both can't be right.

### [Chapter 15 — Final Capstone: The Kestrel Breach](15-capstone-kestrel-breach/README.md) · 5 lessons
